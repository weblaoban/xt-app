<template>
  <div :class="'title ' + 'title' + currentCat + ' title' + status">
    ...
    <div class="titlePrefixCon" v-if="currentCat === 101 || currentCat === 102">
    ...
    <img
      v-if="(currentCat === 101 || currentCat === 102) && item.tpe === 0"
      class="bao"
      src="/img/chu.png"
      alt=""
    />
    <img
      v-if="(currentCat === 101 || currentCat === 102) && item.tpe === 1"
      class="bao"
      src="/img/zhong.png"
      alt=""
    />
...
<style lang="scss" scoped>
  .title {
    ...
    &.title99 {
      .titlePrefix {
        background-image: -webkit-linear-gradient(right, #fd644f, #f18e26);
        border-image: linear-gradient(-90deg, #fd644f, #f18e26) 1 1;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        width: 0.92rem;
        height: 0.3rem;
    ...
    &.title3 {
      .titlePrefix {
        background-image: -webkit-linear-gradient(right, #fad126, #f39800);
        border-image: linear-gradient(-90deg, #fad126, #f39800) 1 1;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        width: 0.92rem;
        height: 0.3rem;
    ...
    &.title98 {
      .titlePrefix {
        background-image: -webkit-linear-gradient(right, #38ebba, #6fb1d2);
        border-image: linear-gradient(-90deg, #38ebba, #6fb1d2) 1 1;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        width: 0.92rem;
        height: 0.3rem;
